...
export default function Home(): ReactNode {
    return (
        <div className='grid grid-cols-4 gap-4 justify-between'>
            ...
            <Alert severity={'danger'} variant={'primary'} style={'filled'} title={'title'} message={'message'} />
            ...
            <Alert severity={'danger'} variant={'primary'} style={'outlined'} title={'title'} message={'message'} />
            ...
            <Alert severity={'danger'} variant={'colored'} style={'filled'} title={'title'} message={'message'} />
            ...
            <Alert severity={'danger'} variant={'colored'} style={'outlined'} title={'title'} message={'message'} />
            ...
            <Alert severity={'danger'} variant={'colored-icon'} style={'filled'} title={'title'} message={'message'} />
            ...
            <Alert severity={'danger'} variant={'colored-icon'} style={'outlined'} title={'title'} message={'message'} />
